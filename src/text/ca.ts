...
export const ca = {
  ...
  guide: {
    ...
    editSection: "Editar secció",
  },

  /** Editor de seccions de la guia (mode edició). */
  guideEditor: {
    newTitle: "Nova secció",
    editTitle: "Editar secció",
    iconLabel: "Icona",
    titleLabel: "Títol de la secció",
    titlePlaceholder: "Títol de la secció",
    blocksLabel: "Contingut",
    addBlock: "Afegir bloc",
    /** Etiquetes dels tipus de bloc al desplegable. */
    blockTypes: {
    ...
    headingPlaceholder: "Encapçalament",
    paragraphPlaceholder: "Escriu el paràgraf…",
    notePlaceholder: "Avís o consell destacat…",
    stepsHint: "Una línia per pas (enumeració numerada).",
    listHint: "Una línia per element (llista amb pics).",
    itemsPlaceholder: "Un element per línia",
    captionPlaceholder: "Peu de la imatge (opcional)",
    addImage: "Afegir imatge",
    replaceImage: "Substituir imatge",
    processing: "Processant…",
    deleteBlock: "Eliminar bloc",
    moveUp: "Amunt",
    moveDown: "Avall",
    save: "Guardar secció",
    saveConfirm: "Sí, guardar",
    deleteSection: "Eliminar secció",
    deleteSectionConfirm: "Sí, eliminar la secció",
    titleRequired: "Cal un títol per a la secció.",
  },
