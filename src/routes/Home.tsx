...
export function Home() {
  ...
  const secondaryCount = 2 + (prefs.showFaultsButton ? 1 : 0) + (prefs.showDocumentsButton ? 1 : 0)
  const secondaryCols =
                ...
                <li key={o.id}>
                  ...
                  >
                      ...
                      <span className="text-left">
                        ...
                        {o.capacityLiters ? (
                          <span className="block text-xs text-boat-500">
                            {t.home.litersPerBottle(o.capacityLiters)}
                          </span>
                        ) : null}
                      </span>
                    </span>
                    <span className="text-right text-sm text-boat-500">
                      ...
                      {liters !== null && (
                        <span className="block text-xs">{Math.round(liters * 10) / 10} L</span>
                      )}
                    </span>
                  </button>
                </li>
